        ...
        <footer className={styles.footer}>
            ...
            <div className={styles.info}>
                ...
                <div className={styles.social}>
                    <nav className={styles.info_desciption} aria-label="Company information">
                        <div className={styles.resume}>
                            <p className={styles.company_name}>© 2025 Neurolover</p>
                        </div>
                    </nav>
                    ...
                    <nav className={styles.link} aria-label="Footer navigation">
                        <a href="/privacy-policy" className={styles.links}>Privacy Policy</a>
                        <a href="/terms-of-service" className={styles.links}>Terms Of Service</a>
                        <a href="/contact" className={styles.links}>Contact Us</a>
                    </nav>
